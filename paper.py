...
class ArxivPaper:
    ...
    def tldr(self) -> str:
        ...
        prompt = """针对计算机科学系的研究生，基于the title, abstract, introduction and the conclusion (if any) of a paper in latex format, 用emoji感叹号开头，用通俗易懂的语言生成一句话总结 TLDR summary in __LANG__:
